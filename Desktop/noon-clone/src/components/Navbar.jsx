...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="relative bg-[#84C7D0] px-4 py-3 flex items-center justify-center">
        <Link to="/" className="font-bold text-xl absolute left-5 ">Omnia</Link>

        <div className='w-[50%]'>
          <input type="text" placeholder='What do you wish to find ?' className=
            'bg-white rounded-[5px] p-2 w-full'
          />
        </div>
      ...
      <nav className='bg-[#75DDDD] flex justify-center items-center gap-5 py-2'>
